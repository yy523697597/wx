  ...
  if (e)
    for (; util.isCollision(t, e); )
      t.start.x > 0
        ...
        : t.start.x < 0
          ? t.start.y++
          : t.start.y > 0 ? t.start.y++ : t.start.y--;
  return t;
}
  ...
  return (
    (i =
      a >= 1e4
        ...
        : a >= 1e3
          ? 100
          : a >= 100 ? 10 : a >= 10 ? 5 : a >= 1 ? 1 : a >= 0.1 ? 0.1 : 0.01),
        ...
        (f =
          c > 0
            ...
            : e < 0
              ...
              : d > 0 ? Math.max(d, l.start.y) : Math.min(d, l.start.y)),
        c < 0 && (c -= x);
      var u = {
        lineStart: { x: o, y: h },
        lineEnd: { x: e, y: a },
...
var Charts = function(t) {
  ...
  (e.yAxisTitleWidth =
    ...
    (this.opts = t),
    (this.config = e),
    (this.context = wx.createCanvasContext(t.canvasId)),
    (this.chartData = {}),
